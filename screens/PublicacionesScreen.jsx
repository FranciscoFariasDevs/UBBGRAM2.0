...
import { View, Text, StyleSheet, FlatList, Image, ActivityIndicator, TouchableOpacity, Modal, TextInput, Dimensions , Button} from 'react-native';
...
const PublicacionesScreen = () => {
  ...
  const categories = [
    ...
    { label: 'Eventos Académicos', value: 'Eventos Académicos' },
    { label: 'Investigación', value: 'Investigación' },
    { label: 'Becas y Ayudas', value: 'Becas y Ayudas' },
    { label: 'Relaciones Institucionales', value: 'Relaciones Institucionales' },
...
//NOLOBORREN
  ...
  return (
    <View style={styles.container}>
        ...
        <View style={styles.modalContainer}>
          <View style={styles.modalContent}>
              ...
              {reportReasons.map((reason) => (
                <TouchableOpacity
                  ...
                  style={[
                    ...
                    selectedReason === reason ? styles.selectedReportOption : null
                  ]}
                  onPress={() => setSelectedReason(reason)}
                >
                  <Text style={[
                    styles.reportReasonText,
                    selectedReason === reason ? styles.selectedReportOptionText : null]}>{reason}</Text>
                </TouchableOpacity>
              ))}
            </View>
           ...
           <View style={styles.modalButtons}>
            <Button title="Cancelar" color="#ef8016" onPress={() => setModalVisible(false)} />
            <Button title="Reportar" color="#143d5c" onPress={handleReport} />
            </View>
          </View>
        </View>
      </Modal>
      ...
      <Modal
        visible={optionsModalVisible} transparent={true} animationType="slide"
